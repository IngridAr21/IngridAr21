...
- **[Temporal Knowledge Graphs](https://github.com/IngridAr21/Temporal_Knowledge_Graphs/tree/main)** – **Bachelor Thesis Project** conducted in collaboration with **Mercedes-Benz Customer Assistance Center (CAC)**. It focuses on building **Temporal Knowledge Graphs** from **emails, call transcripts, and case descriptions** to represent how **customer cases evolve over time** through **entity and relationship extraction** using **NLP** and **LLM-based methods**.
...
- **[Graph Colouring](https://github.com/IngridAr21/Graph-Coloring)** – Java-based exploration of the **Graph Colouring Problem**, combining algorithmic optimisation with an interactive game that tests human strategies.
...
- Data Processing & Audio: Librosa, Pandas, NumPy
- Cloud & DevOps: Google Cloud Platform, Amazon S3, Docker, Terraform
